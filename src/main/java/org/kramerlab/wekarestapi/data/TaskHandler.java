...
import static org.kramerlab.wekarestapi.data.Task.Status.*;
 ...
 * Asynchronous jobs are handled via the TaskHandler class. Task data is stored in <strong>{@link org.kramerlab.wekarestapi.data.Task}</strong> class.<br />
 * <b>Example:</b>
 * <pre>
 * {@code
