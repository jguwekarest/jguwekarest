...
public class StringUtil {
    ...
    /**
     * Check if an array contains a specific value (with
     ...
     * <p>
     * Note: This might be replaced by utility method from
     * commons-lang or guava someday if one of those libraries is
     * added as dependency.
     * </p>
     *
     * @param array
    ...
    /**
     * Check a String for a trailing slash and adds a slash if there
     * is none
     *
     * @param str
     *     The URI string
    ...
    public static Boolean isUri(String uriString) {
        UrlValidator urlValidator = new UrlValidator(StringUtil.schemes);
