...
public class Bayes {
    ...
    public Response algorithmBayesNetPost(
        ...
        throws io.swagger.api.NotFoundException, IOException {
                ...
                return delegate.algorithmPost(fileInputStream, fileDetail, datasetUri, "BayesNet", params, null, metaParams,
    ...
    public Response algorithmBayesNetAdaBoostPost(
        ...
        return delegate.algorithmPost(fileInputStream, fileDetail, datasetUri, "BayesNet", params, "AdaBoost", metaParams,
            headers, ui, securityContext);
        //return delegate.algorithmBayesNetPost(fileInputStream, fileDetail, datasetUri, estimator, estimatorParams, useADTree, searchAlgorithm, searchParams, headers, ui, securityContext);
    }
}
