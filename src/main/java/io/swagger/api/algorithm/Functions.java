...
public class Functions {
    ...
    public Response algorithmLRPost(
        ...
        return delegate.linearRegressionPost(fileInputStream, fileDetail, datasetUri, attributeSelectionMethod, eliminateColinearAttributes, ridge, subjectid, securityContext);
    }
    ...
    public Response algorithmLibSVMPost(
        ...
        return delegate.libSVMPost(fileInputStream, fileDetail, datasetUri, svmType, coef0, cost, degree, eps, gamma, kernelType, loss,
                normalize, nu, probabilityEstimates, shrinking, weights, subjectid, securityContext);
    }
}
